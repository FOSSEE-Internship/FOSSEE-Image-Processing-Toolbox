...
// regularization: Controls the kind of regularization to be applied. The types are:
// <itemizedlist>
//   <listitem> REG_DISABLE: Regularization disabled, flag value = -1 </listitem>
//   <listitem> REG_L1: L1 norm, flag value = 0 </listitem>
//   <listitem> REG_L2: L2 norm, flag value = 1 </listitem>
// </itemizedlist>
//
// trainMethod: Controls the kind of training method to be applied. The types are:
// <itemizedlist>
//   <listitem> BATCH: flag value = 1 </listitem>
//   <listitem> MINI_BATCH: flag value = 0 </listitem>
// </itemizedlist>
//
