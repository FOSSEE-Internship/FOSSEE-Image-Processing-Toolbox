...
//  Sridhar Reddy
    ...
    if (class=="cornerPoints" | class=="BRISKPoints")
    	method="BRISK";    elseif (class=="MSERRegions" | class=="SURFPoints")
    	method="SURF";
    elseif (class=="Matrix")
    	method="Block";
    else
	...
	select class
		...
		case "BRISKPoints" then
			...
			[featureVectors ValidPoints numBits numFeatures scale metrix orientation count]= raw_extractFeatures(imageList, points, "Class", class, "Method", method, "Metric",metric,"Orientation",orientation,"Scale",scale);
		...
		case "SURFPoints" then
			...
			[featureVectors ValidPoints numBits numFeatures count scale metrix signOfLaplacian orientation]= raw_extractFeatures(imageList, points, "Class", class, "Method", method, "Metric",metric,"Orientation",orientation,"Scale",scale,"SignOfLaplacian",signOfLaplacian);
