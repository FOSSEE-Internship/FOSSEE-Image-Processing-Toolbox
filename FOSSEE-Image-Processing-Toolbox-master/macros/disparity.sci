...
//
// Parameters
// method:  Disparity estimation algorithm, specified as the comma-separated pair consisting of 'Method' and      	  //		   character vector 'blockMatching' or 'semi-blockMatching'.
