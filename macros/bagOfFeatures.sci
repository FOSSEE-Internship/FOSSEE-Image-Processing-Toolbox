...
// Author:Rohit Suri & Umang Agrawal
...
//  Umang Agrawal
    ...
    select rhs
        case 1 then
            bagList=raw_bagOfFeatures(imageSetList);
        case 3 then
            bagList=raw_bagOfFeatures(imageSetList,varargin(1),varargin(2));
        case 5 then
            bagList=raw_bagOfFeatures(imageSetList,varargin(1),varargin(2),varargin(3),varargin(4));
        case 7 then
            bagList=raw_bagOfFeatures(imageSetList,varargin(1),varargin(2),varargin(3),varargin(4),varargin(5),varargin(6));
        case 9 then
            bagList=raw_bagOfFeatures(imageSetList,varargin(1),varargin(2),varargin(3),varargin(4),varargin(5),varargin(6),varargin(7),varargin(8));
    end
