...
Color rgb2ntsc(float R, float G, float B)
{
         ...
         float g=G/255.0;
         float b=B/255.0;
         float y =  (0.299*r     + 0.587*g + 0.114*b)*255;
         float i =  (0.596*r     -0.274 *g - 0.322 *b)*255;
         float q =  (0.211*r     - 0.523*g + 0.312 *b)*255;
            ...
            for(int j=0;j<img.cols;j++)
               {
                  ...
                  g1[m]=out.I;
                  b1[m]=out.Q;  
                  img.at<Vec3d>(i,j)[2]=r1[m];
                  img.at<Vec3d>(i,j)[1]=g1[m];
                  img.at<Vec3d>(i,j)[0]=b1[m];
                  //if(R==r1[m])
                  //{sciprint("Guru\n");}
                  m++;
               }
