...
extern "C"
{
  ...
  int opencv_rectifyStereoImages(char *fname, unsigned long fname_len)
  {
   ...
   
   {
    ...
    cv::fisheye::stereoRectify(M1,D1,M2,D2, imgSize, R, T, R1, R2,P1, P2,  Q, CV_CALIB_ZERO_DISPARITY ,pls,0.0,1.0);
   ...
   // transformation and rectification maps
    ...
    cv::fisheye::initUndistortRectifyMap(M1, D1, R1, P1, imgSize , CV_32F, camera1map1, camera1map2);
    cv::fisheye::initUndistortRectifyMap(M2, D2, R2, P2, imgSize, CV_32F, camera2map1, camera2map2);
