...
extern "C"
{
	...
	int opencv_borderInterpolate(char *fname, unsigned long fname_len)
	{
		...
		try
		{
			...
			else if(!strcmp(pstData2[0],"BORDER_REFLECT"))
			{
				borderType= BORDER_REFLECT;
			}
			else if(!strcmp(pstData2[0],"BORDER_REFLECT101"))
			{
				borderType= BORDER_REFLECT101;
			}
			else if(!strcmp(pstData2[0],"BORDER_ISOLATED"))
			{
				borderType= BORDER_ISOLATED;
			}
			else if(!strcmp(pstData2[0],"BORDER_DEFAULT"))
			{
				borderType= BORDER_DEFAULT;
			}
			else if(!strcmp(pstData2[0],"BORDER_REPLICATE"))
			{
